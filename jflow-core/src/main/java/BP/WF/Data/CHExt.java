...
public class CHExt extends EntityMyPK
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		rm.Icon = SystemConfig.getCCFlowAppPath() + "WF/Img/FileType/doc.gif";
		rm.IsForEns = false;
		map.AddRefMethod(rm);
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/WFRpt.jsp?FK_Flow" + this.getFK_Flow() + "&WorkID=" + this.getWorkID() + "&OID=" + this.getWorkID();
	}
}