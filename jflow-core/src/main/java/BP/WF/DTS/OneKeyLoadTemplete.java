...
public class OneKeyLoadTemplete extends Method
{
	...
	public Object Do()
	{
		...
		ess = (EmpStations) ((tempVar5 instanceof EmpStations) ? tempVar5
				: null);
		...
		sems = (SysEnumMains) ((tempVar6 instanceof SysEnumMains) ? tempVar6
				: null);
