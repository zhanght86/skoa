...
public class WFEmp extends EntityNoName
{
	...
	*/
	...
	public final String getTelHtml()
	{
		...
		{
			return "<a href=\"javascript:WinOpen('./Msg/SMS.jsp?Tel=" + this.getTel() + "');\"  ><img src='Img/SMS.gif' border=0/>" + this.getTel() + "</a>";
		}
	}
	public final String getEmailHtml()
	{
		...
		{
			return "<a href='Mailto:" + this.getEmail() + "' ><img src='Img/SMS.gif' border=0/>" + this.getEmail() + "</a>";
		}
	}
