...
/** 
 消息集合
*/
public class Msgs extends ArrayList
{
	...
	*/
	public final int GetMsgsCountByEmpID(int empId)
	{
		...
		if (newMsgNum > 0)
		{
			...
			//    System.Web.HttpContext.Current.Response.Write("<bgsound src='"+BP.Sys.Glo.Request.ApplicationPath+Web.WebUser.getNo()ticeSound+"' loop=1 >"  );
