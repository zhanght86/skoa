...
public abstract class Work extends Entity
{
	...
	*/
	public final String GenerNextUrl()
	{
		...
		return "http://" + ip + "/" + appName + "/WF/Port.aspx?UserNo=" + BP.Web.WebUser.getNo() + "&DoWhat=DoNode&WorkID=" + this.getOID() + "&FK_Node=" + this.getHisNode().getNodeID() + "&Key=MyKey";
	}
		///#endregion
...
//ORIGINAL LINE: public new int Save()
	...
	*/
	...
	protected void afterDelete()
	{
		...
		//    DBAccess.RunSQL("DELETE FROM  " + dtl.getPTable() + " WHERE RefPK=" + this.OID);
