	...
	public Map getEnMap()
	{
		...
		map.AddTBString(FrmAttr.FK_Flow, null, "独立表单属性:FK_Flow", true, false, 0, 50, 10);
		 //   map.AddDDLSysEnum(FrmAttr.FormRunType, 0, "独立表单属性:运行类型", true, false, FrmAttr.FormRunType);
			...
			//表单的运行类型.
		map.AddDDLSysEnum(FrmAttr.FormRunType, BP.WF.FormRunType.FreeForm.getValue(), "运行类型", true, false, FrmAttr.FormRunType, "@0=傻瓜表单@1=自由表单@2=嵌入式表单@4=Excel表单@5=Word表单");
