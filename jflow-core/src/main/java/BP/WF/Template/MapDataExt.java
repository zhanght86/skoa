...
public class MapDataExt extends EntityNoName
{
	...
	*/
	...
	public Map getEnMap()
	{
		...
		map.AddTBString(MapDataAttr.PTable, null, "存储表", true, false, 0, 500, 20);
			...
			//表单的运行类型.
		map.AddDDLSysEnum(MapDataAttr.FrmType, 1, "表单类型", true, false, MapDataAttr.FrmType, "@0=傻瓜表单@1=自由表单@2=Silverlight表单(已取消)@3=嵌入式表单@4=Word表单@5=Excel表单");
		...
		map.AddSearchAttr(MapDataAttr.DBSrc);
			...
			//rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Form.png";
			//rm.Visable = true;
			//rm.Target = "_blank";
			//map.AddRefMethod(rm);
		...
		rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Event.png";
		rm.Visable = true;
		rm.refMethodType = RefMethodType.RightFrameOpen;
		rm.Target = "_blank";
		map.AddRefMethod(rm);
		...
		rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Script.png";
		rm.Visable = true;
		rm.refMethodType = RefMethodType.RightFrameOpen;
		rm.Target = "_blank";
		map.AddRefMethod(rm);
		...
		rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Export.png";
		rm.Visable = true;
		...
		rm.Title = "重命名字段";
		rm.Warning = "您确定要处理吗？";
		rm.getHisAttrs().AddTBString("FieldOld", "", "旧字段英文名", true, false, 0, 100, 100);
		...
		rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Table.gif";
		rm.Visable = true;
		...
		///#endregion 方法 - 开发接口.
			...
			//rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Btn/Word.gif";
			//rm.Visable = true;
			//rm.refMethodType = RefMethodType.RightFrameOpen;
			//rm.Target = "_blank";
			//rm.GroupName = "开发接口";
			...
			//rm.Icon = SystemConfig.getCCFlowWebPath() + "WF/Img/Btn/Excel.gif";
			//rm.Visable = true;
			//rm.refMethodType = RefMethodType.RightFrameOpen;
			//rm.Target = "_blank";
			//rm.GroupName = "开发接口";
	...
	*/
	public final String DoRegularExpressionBatch() {
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/RegularExpressionBatch.jsp?FK_Flow=&FK_MapData=" + this.getNo() + "&t=" + DataType.getCurrentDataTime();
	}
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/AttrNode/SortingMapAttrs.jsp?FK_Flow=&FK_MapData=" + this.getNo() + "&t=" + DataType.getCurrentDataTime();
	}
	  /** 
	 设计表单
	...
	{
		String url = SystemConfig.getCCFlowWebPath() + "WF/MapDef/CCForm/Frm.jsp?FK_MapData=" + this.getNo() + "&UserNo=" + BP.Web.WebUser.getNo() + "&SID=" + WebUser.getSID() + "&AppCenterDBType=" + BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo=" + BP.Sys.SystemConfig.getCustomerNo();
		try {
	...
	*/
	...
	{
		String url = SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapDef.jsp?FK_MapData=" + this.getNo() + "&UserNo=" + BP.Web.WebUser.getNo() + "&SID=" + WebUser.getSID() + "&AppCenterDBType=" + BP.DA.DBAccess.getAppCenterDBType() + "&CustomerNo=" + BP.Sys.SystemConfig.getCustomerNo();;
		try {
			PubClass.WinOpen(ContextHolderUtils.getResponse(),url, 800, 650);
		} catch (IOException e) {
			e.printStackTrace();
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/WordFrm.jsp?s=34&FK_MapData=" + this.getNo() + "&ExtType=WordFrm&RefNo=";
	}
	public final String DoExcelFrm()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/ExcelFrm.jsp?s=34&FK_MapData=" + this.getNo() + "&ExtType=ExcelFrm&RefNo=";
	}
	public final String DoPageLoadFull()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/PageLoadFull.jsp?s=34&FK_MapData=" + this.getNo() + "&ExtType=PageLoadFull&RefNo=";
	}
	public final String DoInitScript()
	{
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/InitScript.jsp?s=34&FK_MapData=" + this.getNo() + "&ExtType=PageLoadFull&RefNo=";
	}
	/** 
	 表单属性.
	...
	*/
	public final String DoBodyAttr() {
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/BodyAttr.jsp?s=34&FK_MapData=" + this.getNo() + "&ExtType=BodyAttr&RefNo=";
	}
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/Admin/Action.jsp?FK_MapData=" + this.getNo() + "&T=sd&FK_Node=0&NodeID=0";
	}
	/** 
	 导出
	...
	*/
	...
	{
		return SystemConfig.getCCFlowWebPath() + "WF/MapDef/MapExt/List.jsp?FK_MapData=" + this.getNo() + "&T=sd";
	}
	/** 
	 导出表单
		 ...
		 for (MapExt item : exts.ToJavaList())
		 {
			 //bool isHave = item.MyPK.Contains("_" + fieldOld);
			  ...
			  //       continue;
				 ...
				 {
					 item.setAttrOfOper(item.getMyPK().replace("_" + fieldOld, "_" + newField));
				 }
