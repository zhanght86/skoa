...
//			{
//				//增加特殊的列。
//				DBAccess.RunSQL("ALTER TABLE  " + ptable + " ADD Tag VARCHAR(4000) DEFAULT '' NULL");
//			}
...
//			}
        ...
        if (DBAccess.IsExitsObject("WF_Track"))
	...
	*/
	...
	protected boolean beforeInsert()
	{
		...
		{
			this.setExer(BP.Web.GuestUser.getName());
		}
		else
		{
			if (BP.Web.WebUser.getIsAuthorize())
			{
				this.setExer(BP.WF.Glo.DealUserInfoShowModel(BP.Web.WebUser.getAuthorizerEmpID(), BP.Web.WebUser.getAuth()));
			}
			else
			{
