...
public class DeptStation extends Entity
{
	...
	public DeptStation(String _empoid, String wsNo)
	{
		...
		if (this.Retrieve(DeptStationAttr.FK_Dept, this.getFK_Dept(),
				DeptStationAttr.FK_Station, this.getFK_Station()) == 0)
		{
			this.Insert();
		}
	}
	...
	public Map getEnMap()
	{
		...
		map.AddTBStringPK(DeptStationAttr.FK_Dept, null, "操作员", false, false,
				1, 15, 1);
