...
public class DeptSearchScorp extends Entity
{
	...
	public Map getEnMap()
	{
		...
		map.AddTBStringPK(DeptSearchScorpAttr.FK_Emp, null, "操作员", true, true,
				1, 50, 11);
		map.AddDDLEntitiesPK(DeptSearchScorpAttr.FK_Dept, null, "部门",
				new Depts(), true);
		// map.AddDDLEntitiesPK(DeptSearchScorpAttr.FK_Emp, null, "����Ա", new
		// Emps(), true);
		this.set_enMap(map);
		return this.get_enMap();
	}
