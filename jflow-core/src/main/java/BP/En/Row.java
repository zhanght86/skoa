...
public class Row extends Hashtable<String, Object>
{
			...
			switch (attr.getMyDataType())
			{
				case BP.DA.DataType.AppInt:
					...
					} else
					{
						try
						{
							this.put(attr.getKey().toLowerCase(), Integer
				...
				case BP.DA.DataType.AppFloat:
					...
					{
						this.put(attr.getKey().toLowerCase(), Float
				...
				case BP.DA.DataType.AppMoney:
					...
					{
						this.put(attr.getKey().toLowerCase(),
				...
				case BP.DA.DataType.AppDouble:
					...
					{
						this.put(attr.getKey().toLowerCase(), Double
	...
	public final Object GetValByKey(String key)
	{
		...
		// {
		// throw new
		// Exception("@GetValByKey没有找到key="+key+"的属性Vale , 请确认Map 里面是否有此属性."+ex.Message);
		// }
		// }
		// else
		// {
