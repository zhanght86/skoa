...
//						objStreamWriter.WriteLine((char)9 + " " + (char)9 + "物理表:" + dtl.Ens.GetNewEntity.EnMap.PhysicsTable);
...
//						objStreamWriter.WriteLine((char)9 + " " + (char)9 + iii + (char)9 + attr.Desc + (char)9 + attr.Key + (char)9 + attr.Field + (char)9 + attr.MyDataTypeStr + (char)9 + attr.DefaultVal + (char)9 + "外键" + (char)9 + "关连的实体:" + tmp.EnDesc + "物理表:" + tmp.EnMap.PhysicsTable + " 关于" + tmp.EnDesc + "信息请到此实体信息里面去找.");
//
...
//					{
//						Entity tmp = attr.HisFKEn;
//						objStreamWriter.WriteLine((char)9 + " " + (char)9 + iii + (char)9 + attr.Desc + (char)9 + attr.Key + (char)9 + attr.Field + (char)9 + attr.MyDataTypeStr + (char)9 + attr.DefaultVal + (char)9 + "外主键" + (char)9 + "关连的实体:" + tmp.EnDesc + "物理表:" + tmp.EnMap.PhysicsTable + " 关于" + tmp.EnDesc + "信息请到此实体信息里面去找.");
//						continue;
//					}
//
//					//其他的情况.
...
//
//		String url = SystemConfig.CCFlowWebPath + "WF/Comm/Port/ErrorPage.aspx?d=" + java.time.LocalDateTime.now().toString();
...
//		System.Web.HttpContext.Current.Session["info"] = msg;
//
//		String url = SystemConfig.CCFlowWebPath + "WF/Comm/Port/InfoPage.aspx?d=" + java.time.LocalDateTime.now().toString();
...
//	{
//		if (tangible.DotNetToJavaStringHelper.isNullOrEmpty(msg))
//		{
//			return;
//		}
//
...
//		System.Web.HttpContext.Current.Response.Redirect(SystemConfig.CCFlowWebPath + "WF/Comm/Port/ToErrorPage.aspx?d=" + java.time.LocalDateTime.now().toString(), false);
//	}
//	/** 
//	 切换到信息也面。
//	 
...
//		{
//			System.Web.HttpContext.Current.Response.Redirect(SystemConfig.CCFlowWebPath + "WF/Comm/Port/InfoPage.aspx?d=" + java.time.LocalDateTime.now().toString(), false);
//		}
//		else
//		{
...
//		{
//			if (this.WhoCanUseIt().equals(WebUser.No))
//			{
//				return;
//			}
...
//	{
//		if (tangible.DotNetToJavaStringHelper.isNullOrEmpty(mess))
//		{
//			return;
//		}
//
