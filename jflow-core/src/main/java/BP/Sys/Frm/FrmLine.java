...
public class FrmLine extends EntityMyPK
{
	...
	public Map getEnMap()
	{
		...
		map.AddMyPK();
		map.AddTBString(FrmLineAttr.FK_MapData, null, "主表", true, false, 0, 30,
				20);
		...
		map.AddTBString(FrmLineAttr.BorderColor, "black", "颜色", true, false, 0,
				30, 20);
	...
	public final boolean IsExitGenerPK()
	{
		String sql = "SELECT COUNT(*) FROM "
				...
				+ this.getY() + " and x1=" + this.getX1() + " and x2="
				+ this.getX2() + " and y1=" + this.getY1() + " and y2="
				+ this.getY2();
		try
		{
