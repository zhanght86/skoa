...
public class MapM2M extends EntityMyPK
{
	...
	public Map getEnMap()
	{
		...
		map.AddTBInt(MapM2MAttr.ShowWay, FrmShowWay.FrmAutoSize.getValue(),
				"显示方式", false, false);
		
		map.AddTBInt(MapM2MAttr.M2MType, M2MType.M2M.getValue(), "类型", false,
				false);
