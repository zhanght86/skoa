...
public class FrmRB extends EntityMyPK
{
	...
	public Map getEnMap()
	{
		...
		map.AddMyPK();
		map.AddTBString(FrmRBAttr.FK_MapData, null, "FK_MapData", true, false,
				0, 30, 20);
		map.AddTBString(FrmRBAttr.KeyOfEn, null, "KeyOfEn", true, false, 0, 30,
				20);
		map.AddTBString(FrmRBAttr.EnumKey, null, "EnumKey", true, false, 0, 30,
				20);
	...
	{
		this.setMyPK(this.getFK_MapData() + "_" + this.getKeyOfEn() + "_"
				+ this.getIntKey());
