...
public class FrmImgAth extends EntityMyPK
{
	...
	public Map getEnMap()
	{
		...
		map.AddTBString(FrmImgAthAttr.FK_MapData, null, "表单ID", true, false, 1,
				30, 20);
		map.AddTBString(FrmImgAthAttr.CtrlID, null, "控件ID", true, false, 0,
				200, 20);
		
		// map.AddTBString(FrmImgAthAttr.CtrlName, null, "控件名称", true, false, 0,
		// 200, 20);
