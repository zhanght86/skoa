...
public class FrmEle extends EntityMyPK
{
	...
	public final int getHOfInt()
	{
		...
		/*
		 * warning return Integer.parseInt((new
		 * Float(this.getH())).ToString("0"));
		 */
	}
	...
	public Map getEnMap()
	{
		...
		map.AddTBString(FrmEleAttr.FK_MapData, null, "FK_MapData", true, false,
				1, 30, 20);
		map.AddTBString(FrmEleAttr.EleType, null, "EleType可扩展的", true, false,
				0, 50, 20);
	...
	{
		this.setMyPK(this.getFK_MapData() + "_" + this.getEleType() + "_"
				+ this.getEleID());
