...
public class SysEnumMain extends EntityNoName
{
	...
	{
		// DataTable dt =
		// BP.DA.DBAccess.RunSQL("SELECT DISTINCT EnumKey FROM SYS_Enum WHERE EnumKey Not IN (SELECT No FROM SYS_EnumMain )");
	...
	public Map getEnMap()
	{
		...
		map.AddTBString(SysEnumMainAttr.CfgVal, null, "配置信息", true, false, 0,
				1500, 8);
