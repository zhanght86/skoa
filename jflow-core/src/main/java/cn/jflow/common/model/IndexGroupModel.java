...
public class IndexGroupModel extends BaseModel {
	...
	public IndexGroupModel(HttpServletRequest request,HttpServletResponse response){
...
//        Entities ens = this.HisEns;
            ...
            for(Attr attr : AttrsOfGroup){
                if (attr.getKey().equals(getOrderBy())){
                	if("Down".equals(getOrderWay())){
                		...
                		//UCSys1.append(AddTDGroupTitle("<a href='/../../WF/Rpt/Group.jsp?EnsName=" + this.getEnsName() + "&OrderBy=" + attr.getKey() + "&OrderWay=Up' >" + attr.getDesc() + "<img src='../Img/ArrDown.gif' border=0/></a>"));
                	...
                	if("Down".equals(getOrderWay())){
                		if (key.equals(getNumKey()))
                			//UCSys1.append(AddTDGroupTitle(lab + "<a href='" + getPageID() + ".jsp?FK_Flow=" + getFkFlow() + "&DoType=" + getDoType() + "&RptNo=" + getRptNo() + "&NumKey=" + key + "&OrderBy=" + key + "&OrderWay=Up'><img src='"+basePath+"WF/Img/ArrDown.gif' border=0/></a>"));
                		  	UCSys1.append(AddTDGroupTitle(lab + "<a href='Group.jsp?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "&OrderBy=" + attr.getKey() + "&OrderWay=Up'><img src='../Img/ArrDown.gif' border=0/></a>"));
                		else
                			...
                			UCSys1.append(AddTDGroupTitle("<a href=\"Group.jsp?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "\" >" + lab + "</a><a href='Group.aspx?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "&OrderBy=" + attr.getKey() + "&OrderWay=Up'><img src='../Img/ArrDown.gif' border=0/></a>"));
                	}else{
                		if (key.equals(getNumKey()))
                			//UCSys1.append(AddTDGroupTitle(lab + "<a href='" + getPageID() + ".jsp?FK_Flow=" + getFkFlow() + "&DoType=" + getDoType() + "&RptNo=" + getRptNo() + "&OrderBy=" + key + "&NumKey=" + key + "&OrderWay=Down'><img src='"+basePath+"WF/Img/ArrUp.gif' border=0/></a>"));
                		  	UCSys1.append(AddTDGroupTitle(lab + "<a href='Group.jsp?EnsName=" + this.getEnsName() + "&OrderBy=" + attr.getKey() + "&NumKey=" + attr.getKey() + "&OrderWay=Down'><img src='../Img/ArrUp.gif' border=0/></a>"));
                		else
                			//UCSys1.append(AddTDGroupTitle("<a href=\"" + getPageID() + ".jsp?FK_Flow=" + getFkFlow() + "&DoType=" + getDoType() + "&RptNo=" + getRptNo() + "&NumKey=" + key + "\" >" + lab + "</a><a href='" + getPageID() + ".jsp?RptNo=" + getRptNo() + "&OrderBy=" + key + "&NumKey=" + key + "&OrderWay=Down&FK_Flow=" + getFkFlow() + "'><img src='"+basePath+"WF/Img/ArrUp.gif' border=0/></a>"));
                		 	UCSys1.append(AddTDGroupTitle("<a href=\"Group.jsp?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "\" >" + lab + "</a><a href='Group.jsp?EnsName=" + this.getEnsName() + "&OrderBy=" + attr.getKey() + "&NumKey=" + attr.getKey() + "&OrderWay=Down'><img src='../Img/ArrUp.gif' border=0/></a>"));
                	}
                }else{
                    if (key.equals(getNumKey()))
                    	...
                    	UCSys1.append(AddTDGroupTitle(lab + "<a href='Group.jsp?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "&OrderBy=" + attr.getKey() + "' ><img src='../Img/ArrDownUp.gif' border=0/></a>"));
                    else
                    	...
                    	UCSys1.append(AddTDGroupTitle("<a href=\"Group.jsp?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "\" >" + lab + "</a><a href='Group.jsp?EnsName=" + this.getEnsName() + "&NumKey=" + attr.getKey() + "&OrderBy=" + attr.getKey() + "' ><img src='../Img/ArrDownUp.gif' border=0/></a>"));
                }
            }
            
            //UCSys1.append(AddTDGroupTitle("挖掘"));
        ...
        YSurl.append(SystemConfig.getCCFlowWebPath()+"/WF/Rpt/GroupDtl.jsp?RptNo=").append(getRptNo()).append("&FK_Flow=").append(getFkFlow());
        ...
        for(DataRow dr : dt.Rows){
            ...
            UCSys1.append(AddTD("<a href=\"javascript:OpenEasyUiDialog('" + url + "','eudlgframe','详细信息',900,432,'icon-table',false,null,null,document.getElementById('mainDiv'))\" class='easyui-linkbutton'>详细</a>"));
            UCSys1.append(AddTREnd());
        }
            ...
            switch (attr.getMyDataType())
            {
                ...
                case DataType.AppRate:
                    if (StateNumKey.indexOf(attr.getKey() + "=AMOUNT") != -1){ /*  如果本数据列 包含累计 */
                        ...
                        for(DataRow dr1 : dt.Rows){
                            try{
                            	if(String.valueOf(dr1.getValue(attr.getKey())).equals(null)||String.valueOf(dr1.getValue(attr.getKey())).equals("")){
                            	d = d.add(BigDecimal.valueOf(Double.valueOf(String.valueOf(dr1.getValue(attr.getKey())))));
                            	}else{
