        ...
        for(String gVal : gVals) {
            ...
            for(int drNum=0;drNum<dt.Rows.size();drNum++){
            	...
            	if(Glo.getIsWinOpenEmpWorks()){
            		if (isRead == 0){
            			rtnHtml.append(AddTD("onclick=\"SetImg('" + appPath + "','I" + gIdx + "_" + i + "')\"", "<a href=\"javascript:WinOpenIt('" + appPath + "WF/MyFlow.jsp?FK_Flow=" + FK_Flow + "&FK_Node=" + FK_Node + "&FID=" + FID + "&WorkID=" + WorkID + "&IsRead=0&T=" + timeKey + "','" + WorkID + "');\" ><img class=Icon src='"+appPath+"WF/Img/Mail_UnRead.png' id='I" + gIdx + "_" + i + "' />" + Title + "</a>"));
            		}else{
