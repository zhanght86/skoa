...
public class ServletRequestAttributes extends AbstractRequestAttributes {
	...
	static {
		immutableValueTypes.add(Byte.class);
		immutableValueTypes.add(Short.class);
		immutableValueTypes.add(Integer.class);
		immutableValueTypes.add(Long.class);
		immutableValueTypes.add(BigInteger.class);
		immutableValueTypes.add(Float.class);
		immutableValueTypes.add(Double.class);
		immutableValueTypes.add(BigDecimal.class);
