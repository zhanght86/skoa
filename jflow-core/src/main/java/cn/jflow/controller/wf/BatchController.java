...
//								isChange = true;
        ...
        //msg = Glo.getCCFlowAppPath()+"WF/MyFlow.jsp?FK_Flow=" + flowNo + "&FK_Node=" + flowNo + "01&DoFunc=SetParentFlow&CFlowNo=" + nd.getFK_Flow() + "&WorkIDs=" + ids;
 		...
 		mv.setViewName("redirect:" + "/WF/MyFlow.jsp");
		return mv;
	}
