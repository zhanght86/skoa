	...
	*/
	...
	public final void EditSln()
	{
		...
		if (attr.getMyDataType()== DataType.AppString)
		{
			...
			this.Pub1.append(AddTD(cb));
			this.Pub1.append(AddTD("如果是，并且需要在当前方案显示当前人员的签名：<br>请在默认值里输入@WebUser.No"));
			this.Pub1.append(AddTREnd());
		}
		...
		this.Pub1.append(AddBR("3, 如果当前方案需要读取以前的数字签名，那就清除默认值信息，否则就设置@WebUser.No 获取当前操作员的数字签名。"));
		this.Pub1.append(AddFieldSetEnd());
	}
