...
public class NewFrmGuideModel extends BaseModel {
	...
	public final void BindStep0() {
		...
		this.Pub1.append(AddFieldSet("<a class='title' href='?Step=1&FrmType=" + FrmType.Column4Frm.getValue() + "&FK_FrmSort=" + this.getFK_FrmSort()
	...
	public final void BindStep1() {
		...
		if (this.getFrmType() != FrmType.Url.getValue()) {
			if (this.getFrmType() == FrmType.FreeFrm.getValue() || this.getFrmType() == FrmType.Column4Frm.getValue()
					|| this.getFrmType() == FrmType.SLFrm.getValue()) {
