...
public class RegularExpressionModel extends BaseModel{
	...
	public final void BindReTemplete()
	{
		...
		this.Pub1.append(Add("<input type='button' value='返回' onclick=back('RegularExpression.jsp?FK_MapData=" + this.getFK_MapData() + "&ExtType=" + this.getExtType() + "&OperAttrKey=" + this.getOperAttrKey() + "&DoType=New')>"));
