...
<link rel="stylesheet" type="text/css" href="<%=basePath%>WF/assets/css/amazeui.min.css" />
<link rel="stylesheet" type="text/css" href="<%=basePath%>WF/assets/css/admin.css">
<link rel="stylesheet" type="text/css" href="<%=basePath%>WF/assets/css/amazeui.datetimepicker.css">
<link rel="stylesheet" type="text/css" href="<%=basePath%>WF/Scripts/uploadify/style/uploadify.css">
<link rel="stylesheet" type="text/css" href="<%=basePath%>WF/assets/css/jflow.css">

<script type="text/javascript" src="<%=basePath%>WF/Scripts/easyUI/jquery-1.8.0.min.js"></script>
<script type="text/javascript" src="<%=basePath%>WF/assets/js/amazeui.min.js"></script>
<script type="text/javascript" src="<%=basePath%>WF/assets/js/amazeui.datetimepicker.js"></script>
<script type="text/javascript" src="<%=basePath%>WF/assets/js/amazeui.datetimepicker.min.js"></script>
<script type="text/javascript" src="<%=basePath%>WF/assets/js/app.js"></script>
...
<script type="text/javascript" src="<%=basePath%>WF/Scripts/uploadify/jquery.uploadify.min.js"></script> --%>