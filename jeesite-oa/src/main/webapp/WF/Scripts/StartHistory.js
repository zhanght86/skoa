            ...
            columns: [
                   ...
                   { display: '状态', name: 'WFState', render: function (rowdata, rowindex) {
                       switch (rowdata.WFState) {
                           ...
                           case 1:
                              // return "草稿";
                               return "<img src='../WF/Img/WFState/Draft.png'   class='imgWFstate' />" + "   草稿";
                               break;
                           case 2:
                               //return "运行中"; 
                               return "<img src='../WF/Img/WFState/Runing.png'   class='imgWFstate' />" + "   运行中";
                               break;
                           case 3:
                               return "已完成";
                           ...
                           case 4:
                              // return "挂起";
                               return "<img src='../WF/Img/WFState/HungUp.png'   class='imgWFstate' />" + "   挂起";
                               break;
                           case 5:
                               //return "退回"; 
                               return "<img src='../WF/Img/WFState/RebackOverFlow.png'  class='imgWFstate' />" + "   退回";
                               break;
                           case 6:
                               return "转发";
                               break;
                           case 7:
                               //return "删除";
                               return "<img src='../WF/Img/WFState/Cancel.png'   class='imgWFstate' />" + "   删除";
                               break;
                           default:
                               return "";
                               break;
