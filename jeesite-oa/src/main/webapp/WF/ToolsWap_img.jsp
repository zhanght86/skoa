										...
										<fieldset width='100%'>
											...
											<div style="width: 800;height: 550">
												<div style="margin-left: 20px;margin-top: 20px">
														<input type="file" id="file1" name="UpFile" size="46" onchange="document.getElementById('imgx').value=getFullPath(this);"/>
														<input type="button" id="btnImg" value="确定" name="btnOk"/>
													</div>
														<div class="container">
															<div class="row">
																<div class="span12">
																	<div class="jc-demo-box">
																		...
																		<img src="<%=basePath%>/DataUser/UserIcon/<%=WebUser.getNo()%>BigerCon.png" id="target" alt="[Jcrop Example]" />
