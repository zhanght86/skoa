...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    FlowFormTreeEditModel editModel = new FlowFormTreeEditModel(request);
    editModel.InitToolsBar();
    %>
<!DOCTYPE>
<html>
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $("#flowFormTree").tree({
                    ...
                    onClick: function (node) {
                        if (node.attributes.NodeType == "form|0" || node.attributes.NodeType == "form|1") {/*普通表单和必填表单*/
                            ...
                            var url = "../CCForm/Frm.jsp?FK_MapData=" + node.id + "&IsEdit=1&IsPrint=0" + urlExt;
            ...
            var urlExt = urlExtFrm();
            if (args.WorkID) {
                addTab("trackid", "轨迹", "../WorkOpt/OneWork/Track.jsp?1=1" + urlExt);
            }
            //tab页操作事件
            tabCloseEven();
        });
