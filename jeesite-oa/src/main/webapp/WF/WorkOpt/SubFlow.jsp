...
<body leftMargin=0 topMargin=0 >
   <%
	...
	for (String str : strs)
	{
		...
		html = "<div style='float:left'><img src='../Img/Min.gif' />&nbsp;" + fl.getName() + "</div> <div style='float:right'><a href=\"javascript:OpenIt('../MyFlow.jsp?FK_Flow=" + fl.getNo() + "&PWorkID=" +WorkID + "&PNodeID=" + sf.getNodeID() + "&PFlowNo=" + nd.getFK_Flow() + "&PFID="+FID+"')\"  >[启动流程]</a></style>";
		sb.AddTR();
