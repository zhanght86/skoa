...
<%@page import="BP.WF.XML.ClassicMenu"%>
<%@page import="BP.WF.XML.ClassicMenus"%>
...
.JS_zhut_n .left ul li a { color:#333; text-decoration:none; font-size:14px; float:left; margin-left:50px;}
    ...
    <div class="JS_zhut"  >
        <div class="JS_zhut_n" >
            ...
            <br />
                ...
                <% 
                    ClassicMenus ens = new ClassicMenus();
                    ens.RetrieveAll();
                    String strs = "";
                    List<ClassicMenu> array = ens.ToJavaList();
                    for(ClassicMenu en : array)
                    {
                        if (en.getEnable() == false)
                            continue;
                        strs += "<li id='d1' style='background:url(" + en.getImg() + ") no-repeat;background-position:15% 0%'  >";
