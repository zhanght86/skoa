...
function Save() {
    ...
    var url = 'RegularExpression.jsp?s=3&FK_MapData=<%=resb.getFK_MapData()%>&RefNo=' + fields + '&ExtType=RegularExpression&OperAttrKey=ND207_QingJiaYuanYin&DoType=templete';
