<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
   <%@page import="cn.jflow.model.wf.admin.ccbpm.BPMDefaultModel" %>
    <%
    String path = request.getContextPath();
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()	+ path + "/";
    BPMDefaultModel bpmd=new BPMDefaultModel(request,response);
    ...
    .icon-flowcloud
{
   ...
   .icon-Menu
   {
      background: url('../../Scripts/easyUI/themes/icons/Menu.png');
    }

   .icon-User
   {
      background: url('../../Scripts/easyUI/themes/icons/User.png');
    }
    .icon-Station
   {
      background: url('../../Scripts/easyUI/themes/icons/station.png');
    }
        .icon-Group
   {
      background: url('../../Scripts/easyUI/themes/icons/Group.png');
    }
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(function () {
            var content = createFrame('Welcome.jsp');
            $('#tabs').tabs('add', {
                title: '首页',
                id: 'WelCome',
                content: content,
...
//                }
        ...
        //登录
        function Login2App() {
            var url = "../../App/Classic/Login.jsp?DoType=Logout";
            window.open(url);
        }
        //退出
        function LoginOut() {
...
<body class="easyui-layout" data-options="fit: true">
    ...
    <div data-options="region:'center',border:true" collapsible="true">
        ...
        <div id="tab-tools">
            <a href="#" class="easyui-linkbutton" data-options="plain:true" onclick="Login2App()"><b style="color: Blue;"><img alt='使用普通用户,登录前台demo系统' src='<%=basePath%>WF/App/Classic/Img/Key.png' style="width:14px;height:14px;"/>登录前台</b></a> 
            <a href="#" class="easyui-linkbutton" data-options="plain:true" onclick="LoginOut()"><b style="color: Blue;"><img alt='退出ccbpm流程设计器' src='<%=basePath%>WF/Img/Exit.png' style="width:14px;height:14px;"/>退出</b></a>
        </div>
    </div>
    <!--  context menu -->
