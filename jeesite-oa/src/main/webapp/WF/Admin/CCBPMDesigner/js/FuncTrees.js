...
①支持无限级节点设置；②支持任一级别从WebService获取DataTable的Json数据填充（此连接WebService使用的是CCBPMDesignerData.js文件中的ajaxService方法，未另写方法，请注意）；③支持各级节点的图标、右键绑定菜单、展开状态、双击链接Url的规则设置，支持多级嵌套规则设置；④链接Url支持node属性值、node.attributes属性值及WebUser属性值、JS表达式计算结果的自动替换（使用“@@属性字段名”来代替要替换的属性；使用`符号来将要计算结果的JS表达式前后包含起来，表达式中允许含有@@参数名，计算时，先将@@参数名替换成对应的参数值，然后进行计算JS表达式。如设置Url: "Rpt/Group.jsp?FK_Flow=@@fk_flow&RptNo=`'ND'+parseInt('@@fk_flow')+'MyRpt'`"，@@fk_flow=001，则打开页面时，自动计算为："Rpt/Group.jsp?FK_Flow=001&RptNo=ND1MyRpt"）
			...
			{ Type: "Service", ServiceMethod: "GetFlowTree", ColId: "no", ColParentId: "parentno", ColName: "name", RootParentId: "F0",
			    ColDefine: "ttype", Defines: [
											...
											{ Value: "FLOW", ColDefine: "dtype", Defines: [
                                                { Value: "1", IconCls: "icon-flow1", MenuId: "mFlow", InheritForChild: [{ From: "@@id", To: "fk_flow"}], Inherits: ["fk_flow"], Url: "Designer.jsp?FK_Flow=@@id&UserNo=@@WebUser.No&SID=@@WebUser.SID&Flow_V=1" },
                                                { IconCls: "icon-flow1", MenuId: "mFlow", InheritForChild: [{ From: "@@id", To: "fk_flow"}], Inherits: ["fk_flow"], Url: "Designer.jsp?FK_Flow=@@id&UserNo=@@WebUser.No&SID=@@WebUser.SID&Flow_V=1" }
                                            ], /*LazyLoad: true, Nodes: [
                                                { Type: "Node", Id: "RelatedFunction", ParentId: null, Name: "基础功能", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_flow"],
                                                    Nodes: [
//						                                { Type: "Node", Id: "FlowAttrs", ParentId: "RelatedFunction", Name: "流程属性", TType: "NORMAL", DType: "-1", IconCls: "icon-property", Inherits: ["fk_flow"], Url: "../../Comm/RefFunc/UIEn.jsp?EnsName=BP.WF.Template.FlowSheets&No=@@fk_flow" },
						                                { Type: "Node", Id: "FlowAttrs", ParentId: "RelatedFunction", Name: "流程属性", TType: "NORMAL", DType: "-1", IconCls: "icon-property", Inherits: ["fk_flow"], Url: "../../Comm/RefFunc/UIEn.jsp?EnsName=BP.WF.Template.FlowExts&No=@@fk_flow" },
						                                { Type: "Node", Id: "NodeAttrs", ParentId: "RelatedFunction", Name: "节点设置", TType: "NORMAL", DType: "-1", IconCls: "icon-Node", Inherits: ["fk_flow"], Url: "../AttrFlow/NodeAttrs.jsp?FK_Flow=@@fk_flow" },
                                                    //	{ Type: "Node", Id: "BatchEditNode", ParentId: "RelatedFunction", Name: "批量修改节点属性", TType: "NORMAL", DType: "-1", IconCls: "icon-edit", Inherits: ["fk_flow"], Url: "../AttrFlow/FeatureSetUI.jsp?FK_Flow=@@fk_flow&FK_Node=&DoType=Name" },
						                                {Type: "Node", Id: "RunFlow", ParentId: "RelatedFunction", Name: "运行流程", TType: "NORMAL", DType: "-1", IconCls: "icon-RunFlow", Inherits: ["fk_flow"], Url: "../TestFlow.jsp?FK_Flow=@@fk_flow&UserNo=admin&SID=@@SID", Target: "_blank" },
						                                { Type: "Node", Id: "FlowCheck", ParentId: "RelatedFunction", Name: "流程检查", TType: "NORMAL", DType: "-1", IconCls: "icon-CheckFlow", Inherits: ["fk_flow"], Url: "../AttrFlow/CheckFlow.jsp?FK_Flow=@@fk_flow" },

						                                { Type: "Node", Id: "f1", ParentId: "RelatedFunction", Name: "发起前置列表", TType: "NORMAL", DType: "-1", IconCls: "icon-StartGuide", Inherits: ["fk_flow"], Url: "../AttrFlow/StartGuide.jsp?NodeID=0&FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "f2", ParentId: "RelatedFunction", Name: "发起限制规则", TType: "NORMAL", DType: "-1", IconCls: "icon-limit", Inherits: ["fk_flow"], Url: "../AttrFlow/Limit.jsp?NodeID=0&FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "f3", ParentId: "RelatedFunction", Name: "自动发起", TType: "NORMAL", DType: "-1", IconCls: "icon-AutoStart", Inherits: ["fk_flow"], Url: "../AttrFlow/AutoStart.jsp?NodeID=0&FK_Flow=@@fk_flow" },


						                                { Type: "Node", Id: "FlowAction", ParentId: "RelatedFunction", Name: "流程事件消息", TType: "NORMAL", DType: "-1", IconCls: "icon-Event", Inherits: ["fk_flow"], Url: "../Action.jsp?NodeID=0&FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "TruckViewPower", ParentId: "RelatedFunction", Name: "轨迹查看权限", TType: "NORMAL", DType: "-1", IconCls: "icon-Setting", Inherits: ["fk_flow"], Url: "../AttrFlow/TruckViewPower.jsp?FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "TruckViewPower", ParentId: "RelatedFunction", Name: "模版导入", TType: "NORMAL", DType: "-1", IconCls: "icon-redo", Inherits: ["fk_flow"], Url: "../AttrFlow/Imp.jsp?FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "TruckViewPower", ParentId: "RelatedFunction", Name: "模版导出", TType: "NORMAL", DType: "-1", IconCls: "icon-unredo", Inherits: ["fk_flow"], Url: "../AttrFlow/Exp.jsp?FK_Flow=@@fk_flow" }
                                                        ]
                                                }, 
                                                { Type: "Node", Id: "JianK", ParentId: null, Name: "流程监控", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_flow"],
                                                    Nodes: [
												            { Type: "Node", Id: "WorkPanel", ParentId: "JianK", Name: "监控面板", TType: "WORKPANEL", DType: "-1", IconCls: "icon-Monitor", Url: "../CCBPMDesigner/App/OneFlow/Welcome.jsp?FK_Flow=@@fk_flow" },
												            { Type: "Node", Id: "list", ParentId: "JianK", Name: "节点列表", TType: "WORKPANEL", DType: "-1", IconCls: "icon-flows", Url: "../CCBPMDesigner/App/OneFlow/Nodes.jsp?FK_Flow=@@fk_flow" },
												            { Type: "Node", Id: "SynthSearch", ParentId: "JianK", Name: "综合查询", TType: "SYNTHSEARCH", DType: "-1", IconCls: "icon-Search", Url: "../../Comm/Search.jsp?EnsName=BP.WF.Data.GenerWorkFlowViews&FK_Flow=@@fk_flow&WFSta=all" },
												            { Type: "Node", Id: "SynthAnalysis", ParentId: "JianK", Name: "综合分析", TType: "SYNTHANALYSIS", DType: "-1", IconCls: "icon-Group", Url: "../../Comm/Group.jsp?EnsName=BP.WF.Data.GenerWorkFlowViews&FK_Flow=@@fk_flow&WFSta=all" },
						                                    { Type: "Node", Id: "SearchByFlow", ParentId: "JianK", Name: "实例增长分析", TType: "SEARCHBYFLOW", DType: "-1", IconCls: "icon-Grow", Url: "../FlowDB/InstanceGrowOneFlow.jsp?anaTime=mouth&FK_Flow=@@fk_flow" },
						                                    { Type: "Node", Id: "FlowRunning", ParentId: "JianK", Name: "逾期未完成实例", TType: "FLOWRUNNING", DType: "-1", IconCls: "icon-Warning", Url: "../FlowDB/InstanceWarning.jsp?FK_Flow=@@fk_flow" },
						                                    { Type: "Node", Id: "FlowExpired", ParentId: "JianK", Name: "逾期已完成实例", TType: "FLOWEXPIRED", DType: "-1", IconCls: "icon-overtime", Url: "../FlowDB/InstanceOverTimeOneFlow.jsp?anaTime=mouth&FK_Flow=@@fk_flow" },
												            { Type: "Node", Id: "DeleteLog", ParentId: "JianK", Name: "删除日志", TType: "DELETELOG", DType: "-1", IconCls: "icon-log", Url: "../../Comm/Search.jsp?EnsName=BP.WF.WorkFlowDeleteLogs&FK_Flow=@@fk_flow" },
												            { Type: "Node", Id: "Rptorder", ParentId: "JianK", Name: "数据订阅", TType: "DATARECEIVE", DType: "-1", IconCls: "icon-RptOrder", Url: "../CCBPMDesigner/App/RptOrder.jsp?FK_Flow=@@fk_flow" }
											              ]
                                                },
                                                { Type: "Node", Id: "DevAPI", ParentId: null, Name: "开发接口(API)", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_flow"],
                                                    Nodes: [
						                                { Type: "Node", Id: "FlowField", ParentId: "DevAPI", Name: "字段视图", TType: "NORMAL", DType: "-1", IconCls: "icon-Field", Inherits: ["fk_flow"], Url: "../AttrFlow/FlowFields.jsp?FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "AsyncBusinessTable", ParentId: "DevAPI", Name: "与业务表同步", TType: "NORMAL", DType: "-1", IconCls: "icon-DTS", Inherits: ["fk_flow"], Url: "../AttrFlow/DTSBTable.jsp?FK_Flow=@@fk_flow&FK_Node=&DoType=Name" },
						                                { Type: "Node", Id: "URLAPI", ParentId: "DevAPI", Name: "URL调用接口", TType: "NORMAL", DType: "-1", IconCls: "icon-URL", Inherits: ["fk_flow"], Url: "../AttrFlow/API.jsp?FK_Flow=@@fk_flow&DoType=Url" },
						                                { Type: "Node", Id: "SDKAPI", ParentId: "DevAPI", Name: "SDK开发接口", TType: "NORMAL", DType: "-1", IconCls: "icon-API", Inherits: ["fk_flow"], Url: "../AttrFlow/APICode.jsp?FK_Flow=@@fk_flow&DoType=SDK" },
						                                { Type: "Node", Id: "FEEAPI", ParentId: "DevAPI", Name: "代码事件开发接口", TType: "NORMAL", DType: "-1", IconCls: "icon-API", Inherits: ["fk_flow"], Url: "../AttrFlow/APICodeFEE.jsp?FK_Flow=@@fk_flow&FK_Node=&DoType=Name" }
                                                        ]
                                                },
                                                { Type: "Node", Id: "DataManage", ParentId: null, Name: "流程报表", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_flow"],
                                                    Nodes: [
						                                { Type: "Node", Id: "DesignReport", ParentId: "DataManage", Name: "设计报表", TType: "NORMAL", DType: "-1", IconCls: "icon-DesignRpt", Inherits: ["fk_flow"], Url: "../../Rpt/OneFlow.jsp?FK_MapData=`'ND'+parseInt('@@fk_flow')+'Rpt'`&FK_Flow=@@fk_flow" },
						                                { Type: "Node", Id: "FlowSearch", ParentId: "DataManage", Name: "流程查询", TType: "NORMAL", DType: "-1", IconCls: "icon-Search", Inherits: ["fk_flow"], Url: "../../Rpt/Search.jsp?FK_Flow=@@fk_flow&RptNo=`'ND'+parseInt('@@fk_flow')+'MyRpt'`" },
						                                { Type: "Node", Id: "SearchAdv", ParentId: "DataManage", Name: "自定义查询", TType: "NORMAL", DType: "-1", IconCls: "icon-SQL", Inherits: ["fk_flow"], Url: "../../Rpt/SearchAdv.jsp?FK_Flow=@@fk_flow&RptNo=`'ND'+parseInt('@@fk_flow')+'MyRpt'`" },
						                                { Type: "Node", Id: "GroupSearch", ParentId: "DataManage", Name: "分组分析", TType: "NORMAL", DType: "-1", IconCls: "icon-Group", Inherits: ["fk_flow"], Url: "../../Rpt/Group.jsp?FK_Flow=@@fk_flow&RptNo=`'ND'+parseInt('@@fk_flow')+'MyRpt'`" },
						                                { Type: "Node", Id: "CrossReport", ParentId: "DataManage", Name: "交叉报表", TType: "NORMAL", DType: "-1", IconCls: "icon-D3", Inherits: ["fk_flow"], Url: "../../Rpt/D3.jsp?FK_Flow=@@fk_flow&RptNo=`'ND'+parseInt('@@fk_flow')+'MyRpt'`" },
						                                { Type: "Node", Id: "ContrastReport", ParentId: "DataManage", Name: "对比分析", TType: "NORMAL", DType: "-1", IconCls: "icon-Contrast", Inherits: ["fk_flow"], Url: "../../Rpt/Contrast.jsp?FK_Flow=@@fk_flow&RptNo=`'ND'+parseInt('@@fk_flow')+'MyRpt'`" }
                                                        ]
                                                },
//                                                { Type: "Node", Id: "CH", ParentId: null, Name: "时效考核", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_flow"],
//                                                    Nodes: [
//						                                { Type: "CH", Id: "ByNodes", ParentId: "DataManage", Name: "按节点分析", TType: "NORMAL", DType: "-1", IconCls: "icon-DesignRpt", Inherits: ["fk_flow"], Url: "../../CH/ByNodes.jsp?FK_Flow=@@fk_flow" },
//						                                { Type: "CH", Id: "ByEmps", ParentId: "DataManage", Name: "按人员分析", TType: "NORMAL", DType: "-1", IconCls: "icon-Search", Inherits: ["fk_flow"], Url: "../../CH/ByEmps.jsp?FK_Flow=@@fk_flow" },
//						                                { Type: "CH", Id: "ByDepts", ParentId: "DataManage", Name: "按部门分析", TType: "NORMAL", DType: "-1", IconCls: "icon-SQL", Inherits: ["fk_flow"], Url: "../../CH/ByDepts.jsp?FK_Flow=@@fk_flow" },
//						                                { Type: "CH", Id: "GroupSearch", ParentId: "DataManage", Name: "分组分析", TType: "NORMAL", DType: "-1", IconCls: "icon-Group", Inherits: ["fk_flow"], Url: "../../CH/ByNodes.jsp?FK_Flow=@@fk_flow" },
//						                                { Type: "CH", Id: "CrossReport", ParentId: "DataManage", Name: "交叉报表", TType: "NORMAL", DType: "-1", IconCls: "icon-D3", Inherits: ["fk_flow"], Url: "../../CH/ByNodes.jsp?FK_Flow=@@fk_flow" },
//						                                { Type: "CH", Id: "ContrastReport", ParentId: "DataManage", Name: "对比分析", TType: "NORMAL", DType: "-1", IconCls: "icon-Contrast", Inherits: ["fk_flow"], Url: "../../CH/ByNodes.jsp?FK_Flow=@@fk_flow" }
//                                                        ]
//                                                },
                                                { Type: "Node", Id: "BindForm", ParentId: null, Name: "绑定表单", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_flow"],
                                                    Nodes: [
						                                { Type: "Node", Id: "AddOneFrmToNodes", ParentId: "BindForm", Name: "加入表单", TType: "ADDTONODES", DType: "-1", IconCls: "", Inherits: ["fk_flow"], Url: "../AttrFlow/AddOneFrmToNodes.jsp?FK_Flow=@@fk_flow" },
						                                { Type: "Service", ServiceMethod: "GetBindingForms", MethodParams: { fk_flow: "@@fk_flow" }, ColId: "NO", ColParentId: "PARENTNO", ColName: "NAME", RootParentId: null, IconCls: "icon-form", Url: "../AttrFlow/BindingForms.jsp?FK_MapData=`'@@id'.split('@')[0]`&FK_Flow=@@fk_flow" }
                                                        ]
                                                }
                                            ]*/
											}
                ...
                Nodes: [
						{ Type: "Node", Id: "FlowMonitor", ParentId: "FlowFunc", Name: "流程监控", Opened: false, TType: "FLOWMONITOR", DType: "-1", IconCls: "icon-tree_folder",
						    Nodes: [
						            ...
						            { Type: "Node", Id: "SynthAnalysis", ParentId: "FlowMonitor", Name: "综合分析", TType: "SYNTHANALYSIS", DType: "-1", IconCls: "icon-Group", Url: "../../Comm/Group.jsp?EnsName=BP.WF.Data.GenerWorkFlowViews" },
                                   /* { Type: "Node", Id: "SearchByFlow", ParentId: "FlowMonitor", Name: "实例增长分析", TType: "SEARCHBYFLOW", DType: "-1", IconCls: "icon-Grow", Url: "../FlowDB/InstanceGrow.jsp?anaTime=mouth" },
                                    { Type: "Node", Id: "FlowRunning", ParentId: "FlowMonitor", Name: "逾期未完成实例", TType: "FLOWRUNNING", DType: "-1", IconCls: "icon-Warning", Url: "../FlowDB/InstanceWarning.jsp" },
                                    { Type: "Node", Id: "FlowExpired", ParentId: "FlowMonitor", Name: "逾期已完成实例", TType: "FLOWEXPIRED", DType: "-1", IconCls: "icon-overtime", Url: "../FlowDB/InstanceOverTime.jsp?anaTime=mouth" },*/
						            { Type: "Node", Id: "DeleteLog", ParentId: "FlowMonitor", Name: "流程删除日志", TType: "DELETELOG", DType: "-1", IconCls: "icon-log", Url: "../../Comm/Search.jsp?EnsName=BP.WF.WorkFlowDeleteLogs" },
						           /* { Type: "Node", Id: "Rptorder", ParentId: "FlowMonitor", Name: "数据订阅", TType: "DELETELOG", DType: "-1", IconCls: "icon-RptOrder", Url: "../CCBPMDesigner/App/RptOrder.jsp" }*/
						            ]
						},
                        { Type: "Node", Id: "TimeCheck", ParentId: "FlowFunc", Name: "时效考核", TType: "TIMECHECK", DType: "-1", IconCls: "icon-tree_folder", 
							Nodes: [
		                            { Type: "Node", Id: "FlowAnalysis", ParentId: "TimeCheck", Name: "按流程分析", TType: "FLOWANALYSIS", DType: "-1", IconCls: "", Url: "../CCBPMDesigner/App/CH/ByFlows.jsp" },
//		                            { Type: "Node", Id: "DeptAnalysis", ParentId: "TimeCheck", Name: "按部门分析", TType: "DEPTANALYSIS", DType: "-1", IconCls: "", Url: "../CCBPMDesigner/App/CH/ByDepts.jsp" },
//		                            { Type: "Node", Id: "AvgAnalysis", ParentId: "TimeCheck", Name: "排名列表", TType: "AVGANALYSIS", DType: "-1", IconCls: "", Url: "../CCBPMDesigner/App/CH/List.jsp" }
		                        ]
                        }/*
                        { Type: "Node", Id: "PDevAPI", ParentId: "FlowFunc", Name: "开发接口", TType: "PDEVAPI", DType: "-1", IconCls: "icon-tree_folder", Nodes: [
                            { Type: "Node", Id: "StructureIntegration", ParentId: "TimeCheck", Name: "组织结构集成", TType: "STRUCTUREINTEGRATION", DType: "-1", IconCls: "", Url: "../Org/Integration.jsp" },
			...
			{ Type: "Node", Id: "FlowCloud", ParentId: null, Name: "流程云", Opened: true, TType: "FLOWCLOUD", DType: "-1", IconCls: "icon-flowcloud",
			    Nodes: [
						{ Type: "Node", Id: "ShareFlow", ParentId: "FlowCloud", Name: "共有流程云", TType: "SHAREFLOW", DType: "-1", IconCls: "icon-flowpublic", Url: "../Clound/PubFlow.jsp" },
						{ Type: "Node", Id: "PriFlow", ParentId: "FlowCloud", Name: "私有流程云", TType: "PRIFLOW", DType: "-1", IconCls: "icon-flowprivate", Url: "../Clound/PriFlow.jsp" }
					  ]
			}*/
		  ]
});
    ...
    Nodes: [
			{ Type: "Service", ServiceMethod: "GetFormTree", ColId: "no", ColParentId: "parentno", ColName: "name", RootParentId: null,
			    ColDefine: "ttype", Defines: [
											...
											{ Value: "FORM", IconCls: "icon-form", MenuId: "mForm", Url: "../../MapDef/CCForm/Frm.jsp?FK_MapData=@@id&UserNo=@@WebUser.No&SID=@@WebUser.SID", LazyLoad: true, InheritForChild: [{ From: "@@id", To: "fk_frm"}], Nodes: [
                                                { Type: "Node", Id: "RelatedFunction", ParentId: null, Name: "相关功能", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_frm"],
                                                    Nodes: [
						                                { Type: "Node", Id: "FormPreview", ParentId: "RelatedFunction", Name: "表单预览", TType: "NORMAL", DType: "-1", IconCls: "icon-Glasses", Inherits: ["fk_frm"], Url: "../../CCForm/Frm.jsp?FK_MapData=@@fk_frm&IsTest=1" },
						                                { Type: "Node", Id: "FormField", ParentId: "RelatedFunction", Name: "表单字段", TType: "NORMAL", DType: "-1", IconCls: "", Inherits: ["fk_frm"], Url: "../CCFormDesigner/FiledsList.jsp?FK_MapData=@@fk_frm" },
						                                { Type: "Node", Id: "PageLoadFull", ParentId: "RelatedFunction", Name: "装载填充", TType: "NORMAL", DType: "-1", IconCls: "icon-LoadFull", Inherits: ["fk_frm"], Url: "../../MapDef/MapExt/PageLoadFull.jsp?s=34&FK_MapData=@@fk_frm&ExtType=PageLoadFull" },
						                                { Type: "Node", Id: "InitScript", ParentId: "RelatedFunction", Name: "内置JS脚本", TType: "NORMAL", DType: "-1", IconCls: "icon-JavaScript", Inherits: ["fk_frm"], Url: "../../MapDef/MapExt/InitScript.jsp?s=34&FK_MapData=@@fk_frm" },
						                                { Type: "Node", Id: "FormAction", ParentId: "RelatedFunction", Name: "表单事件", TType: "NORMAL", DType: "-1", IconCls: "icon-Event", Inherits: ["fk_frm"], Url: "../Action.jsp?FK_MapData=@@fk_frm" },
						                                { Type: "Node", Id: "Imp", ParentId: "RelatedFunction", Name: "模版导入", TType: "NORMAL", DType: "-1", IconCls: "icon-redo", Inherits: ["fk_frm"], Url: "../AttrFlow/imp.jsp?FK_MapData=@@fk_frm" },
						                                { Type: "Node", Id: "Exp", ParentId: "RelatedFunction", Name: "模版导出", TType: "NORMAL", DType: "-1", IconCls: "icon-unredo", Inherits: ["fk_frm"], Url: "../AttrFlow/Exp.jsp?FK_MapData=@@fk_frm" }
                                                        ]
                                                },
                                                { Type: "Node", Id: "DevAPI", ParentId: null, Name: "API接口", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_frm"],
                                                    Nodes: [
						                                { Type: "Node", Id: "NEWAPI", ParentId: "DevAPI", Name: "新建/增加", TType: "NORMAL", DType: "-1", IconCls: "icon-URL", Inherits: ["fk_frm"], Url: "../../CCForm/Frm.jsp?FK_MapData=@@fk_frm&IsTest=1" },
						                                { Type: "Node", Id: "SEARCHAPI", ParentId: "DevAPI", Name: "列表/查询", TType: "NORMAL", DType: "-1", IconCls: "icon-Search", Inherits: ["fk_frm"], Url: "../../Comm/Search.jsp?EnsName=@@fk_frm" },
						                                { Type: "Node", Id: "GROUPAPI", ParentId: "DevAPI", Name: "分组分析", TType: "NORMAL", DType: "-1", IconCls: "icon-Group", Inherits: ["fk_frm"], Url: "../../Comm/Group.jsp?EnsName=@@fk_frm" },
						                                { Type: "Node", Id: "GROUPAPI", ParentId: "DevAPI", Name: "代码事例", TType: "NORMAL", DType: "-1", IconCls: "icon-API", Inherits: ["fk_frm"], Url: "../CCFormDesigner/APICode.jsp?FK_MapData=@@fk_frm" }
                                                ...
                                                { Type: "Node", Id: "TestFrmFunc", ParentId: null, Name: "实验中的功能", Opened: false, TType: "NORMAL", DType: "-1", IconCls: "icon-FuncFolder", Inherits: ["fk_frm"],
                                                    Nodes: [
						                                { Type: "Node", Id: "FormHome", ParentId: "TestFrmFunc", Name: "表单主页", TType: "NORMAL", DType: "-1", IconCls: "icon-Home", Inherits: ["fk_frm"], Url: "../CCFormDesigner/Home.jsp?FK_MapData=@@fk_frm" },
                                                        { Type: "Node", Id: "BasicData", ParentId: "TestFrmFunc", Name: "原始数据", TType: "NORMAL", DType: "-1", IconCls: "", Inherits: ["fk_frm"], Url: "../CCFormDesigner/BasicData.jsp?FK_MapData=@@fk_frm", },
                                                        ]
                                                }*/
                                           ]
											},
...
//						    ColDefine: "ttype", Defines: [
//											{ Value: "SRC", IconCls: "icon-src", MenuId: "mSrc", Url: "../../Comm/RefFunc/UIEn.jsp?EnsName=BP.Sys.SFDBSrcs&No=@@id&t=" + Math.random() },
//											{ Value: "SRCTABLE", IconCls: "icon-srctable", MenuId: "mSrcTable", Url: "../../MapDef/Do.jsp?DoType=EditSFTable&RefNo=@@id&t=" + Math.random() }
//										  ]
//						}
//					  ]
//			},
			{ Type: "Node", Id: "FormRef", ParentId: null, Name: "表单相关", Opened: true, TType: "FORMREF", IconCls: "icon-tree_folder",
			    Nodes: [
			            { Type: "Node", Id: "Tabs", ParentId: "FormRef", Name: "数据源表", TType: "ENUMS", IconCls: "icon-srctable", Url: "../CCFormDesigner/Tables.jsp?t=" + Math.random() },
						{ Type: "Node", Id: "Enums", ParentId: "FormRef", Name: "枚举列表", TType: "ENUMS", IconCls: "icon-enum", Url: "../../Comm/Sys/EnumList.jsp?t=" + Math.random() },
						{ Type: "Node", Id: "JSLib", ParentId: "FormRef", Name: "JS验证库", TType: "JSLIB", IconCls: "icon-js", Url: "../../Comm/Sys/FuncLib.jsp?t=" + Math.random() }
						
					  ]
			}/*,
			{ Type: "Node", Id: "CloundData", ParentId: null, Name: "表单云", Opened: true, TType: "CLOUNDDATA", IconCls: "icon-formcloud",
			    Nodes: [
						{ Type: "Node", Id: "PriForm", ParentId: "CloundData", Name: "共有表单云", TType: "PRIFORM", IconCls: "icon-flowpublic", Url: "../Clound/PubForm.jsp" },
						{ Type: "Node", Id: "ShareForm", ParentId: "CloundData", Name: "私有表单云", TType: "SHAREFORM", IconCls: "icon-flowprivate", Url: "../Clound/PriForm.jsp" }
					  ]
			}*/
		  ]
});
...
functrees.push({
    ...
    Nodes: [
            ...
            { Type: "Node", Id: "OneMore", ParentId: null, Name: "基础设置", Opened: true, TType: "BASICROOT", IconCls: "icon-tree_folder", OSModel: "OneMore",
            			    Nodes: [
						{ Type: "Node", Id: "DeptTypies", ParentId: "OneMore", Name: "部门类型", TType: "DEPTTYPIES", IconCls: "icon-table", Url: "../../Comm/Ens.jsp?EnsName=BP.GPM.DeptTypes" },
						{ Type: "Node", Id: "Duties", ParentId: "OneMore", Name: "职务维护", TType: "DUTIES", IconCls: "icon-table", Url: "../../Comm/Ens.jsp?EnsName=BP.GPM.Dutys" },
			...
			{ Type: "Service", ServiceMethod: "GetStructureTree", ColId: "no", ColParentId: "parentno", ColName: "name", RootParentId: "0",
			    ColDefine: "ttype", Defines: [
											{ Value: "DEPT", ColDefine: "parentno",
											    Defines: [
															{ Value: "0", IconCls: "icon-0", MenuId: "mDeptRoot", InheritForChild: [{ From: "@@id", To: "fk_dept"}], Opened: true },
															{ IconCls: "icon-department", MenuId: "mDept", InheritForChild: [{ From: "@@id", To: "fk_dept"}] }
														]
											},
											...
											//Value:"EMP" 为新加和ccflow 不一致，如果要改成和ccflow一致的情况请删除一下{...}的内容，并放开CCBPMDesigenerBaase里的注释
//											{
//												Value: "EMP", Inherits: ["fk_dept"],  InheritForChild: [{ From: "`'@@id'.split('|')[1]`", To: "fk_dept"}], ColId: "no", ColParentId: "parentno", ColName: "name", RootParentId: null, IconCls: "icon-user-sw", MenuId: "mEmp", Url: "" 
//											}
...
functrees.push({
    ...
    Nodes: [
			...
			{ Type: "Node", Id: "BasicSetting2", ParentId: null, Name: "基础设置", Opened: true, IconCls: "icon-tree_folder",
			    Nodes: [
						{ Type: "Node", Id: "HolidaySetting", ParentId: "BasicSetting2", Name: "节假日设置", IconCls: "icon-Config", Url: "../../Holiday.jsp" },
						/*2016-7-2 pxf 注释 { Type: "Node", Id: "TableStructure", ParentId: "BasicSetting2", Name: "表结构", IconCls: "icon-Config", Url: "../../Comm/Sys/SystemClass.jsp" },*/
//						{ Type: "Node", Id: "SysVal", ParentId: "BasicSetting2", Name: "系统变量", IconCls: "icon-Config", Url: "javascript:void(0)" },
						{ Type: "Node", Id: "FlowPrevSetting", ParentId: "BasicSetting2", Name: "流程预先审批设置", IconCls: "icon-Config", Url: "../GetTask.jsp" },
						/*2016-7-2 pxf 注释 { Type: "Node", Id: "FuncDown", ParentId: "BasicSetting2", Name: "功能执行", IconCls: "icon-Config", Url: "../../Comm/MethodLink.jsp" }*/
					  ]
			}/*2016-7-2 pxf 注释 ,
...
function FuncTrees(sTabsId) {
    ...
    if (typeof FuncTrees._initialized == "undefined") {
        ...
        FuncTrees.prototype.appendNode = function (sTreeId, sParentNodeId, oNode) {
            ...
            /// <param name="oNode" type="Object">待增加的树节点对象，格式如:{ id: 'aaa', text: '节点1', iconCls: 'icon-new', attributes: {MenuId: "myMenu", Url: "xxx.jsp"} } </param>
            $("#" + sTreeId).tree("append", {
