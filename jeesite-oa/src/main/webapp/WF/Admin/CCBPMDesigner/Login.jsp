...
<script src="../../Scripts/easyUI/jquery-1.8.0.min.js" type="text/javascript"></script>
    ...
    <style type="text/css">
        ...
        body
        {
            background: #DCDDDF url(Icons/7AF2Qzt.png);
            color: #000;
            font: 14px Arial;
            margin: 0 auto;
            padding: 0;
        ...
        #content form input[type="text"], #content form input[type="password"]
        {
            ...
            background: #eae7e7 url(Icons/8bcLQqF.png) no-repeat;
        ...
        .button a
        {
            background: url(Icons/8bcLQqF.png) 0 -112px no-repeat;
            color: #7E7E7E;
            font-size: 17px;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
        	...
        	if (success == "" || success == null || success == "null") {
        		...
        		alert("用户名密码错误，注意密码区分大小写，请检查是否按下了CapsLock.");
        	}
        });
        ...
        function onCheck() {
    		...
    		$("#form1").attr("action", '<%=basePath%>WF/admin/ccbpmDesigner/Login.do?DoType=Login'); 
   		 	$("#form1").submit();
    	}
    </script>
			...
			<form method="post" action="Login.jsp?DoType=Login" id="form1">
				...
				<div>
					<input name="TB_UserName" type="text" id="TB_UserName" 
						placeholder="用户名" required="" value="admin" class="username" />
				</div>
				<div>
				...
				<div>
					<input type="button" value="Silverlight版"
						onclick="javascript:window.location.href='<%=basePath%>WF/Admin/xap/Designer.jsp'" />
				</div>
			</form>
			<div class="button">
				<a href="http://ccbpm.mydoc.io/" target="_blank"> <img
					src="../../Img/Help.png" />帮助
				</a>
			</div>
		</section>
