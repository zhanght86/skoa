...
<caption >开发API <div style=" float:right" > <a href="API.jsp">URL调用接口</a><a href="APICode.jsp">代码开发API</a> |  <a href="APICodeFEE.jsp?FK_Flow=<%=flowNo %>">FEE开发API</a>  </div>  </caption> 
...
<legend>发起:</legend>
 ...
 <br />
   ...
   <%
       String url = BP.Sys.SystemConfig.getPathOfWebApp() + "\\WF\\App\\Simple\\Start.jsp";
        %>
   <br>实现列表输出代码，请参考:  <br>
   <font color=gree><b> <%=url %></b></font>
   <br />
   运行Demo: <a href="<%=basePath %>WF/App/Simple/Start.jsp" target="_blank">发起流程</a>
</fieldset>
...
<legend>待办：</legend>
   ...
   <%
       url = BP.Sys.SystemConfig.getPathOfWebApp() + "\\WF\\App\\Simple\\ToDoList.jsp";
        %>
   <br>实现列表输出代码，请参考:  <br>
   <font color=gree><b> <%=url %></b></font>
   <br /> 
   运行Demo: <a href="<%=basePath %>WF/App/Simple/ToDoList.jsp" target="_blank">工作待办</a>
</fieldset>
...
<legend>在途：</legend>
   ...
   <%
       url = BP.Sys.SystemConfig.getPathOfWebApp() + "\\WF\\App\\Simple\\Runing.jsp";
    %>
   <br>实现列表输出代码，请参考:  <br>
   <font color=gree><b> <%=url %></b></font>
   <br /> 
   运行Demo: <a href="<%=basePath %>WF/App/Simple/Runing.jsp" target="_blank">在途工作</a>
</fieldset>
...
<legend>查询：</legend>
   ...
   <br>
   <%
       url = BP.Sys.SystemConfig.getPathOfWebApp() + "\\WF\\App\\Simple\\Search.jsp";
    %>
   <br>实现列表输出代码，请参考:  <br>
   <font color=gree><b> <%=url %></b></font>
   <br /> 
   运行Demo: <a href="<%=basePath %>WF/App/Simple/Search.jsp" target="_blank">查询</a>
</fieldset>
</td>
</tr>
