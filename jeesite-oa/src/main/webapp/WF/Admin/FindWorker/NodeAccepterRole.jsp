...
<script language="javascript" type="text/javascript">
        $(function () {
            ...
            if (document.getElementById("RB_3").checked) {
                onclickSJ(3, true);
            }
            if (document.getElementById("RB_9").checked) {
                onclickSJ(4, true);
            }
            if (document.getElementById("RB_10").checked) {
                onclickSJ(5, true);
            }
            if (document.getElementById("RB_11").checked) {
                onclickSJ(6, true);
            }
            if (document.getElementById("RB_14").checked) {
                onclickSJ(7, true);
            }
            if (document.getElementById("RB_7").checked) {
                onclickSJ(8, true);
            }
            if (document.getElementById("RB_6").checked) {
                onclickSJ(9, true);
            }
            if (document.getElementById("RB_8").checked) {
                onclickSJ(10, true);
            }
            if (document.getElementById("RB_2").checked) {
                onclickSJ(11, true);
            }
            if (document.getElementById("RB_12").checked) {
                onclickSJ(12, true);
            }
            if (document.getElementById("RB_4").checked) {
                onclickSJ(13, true);
            }
            if (document.getElementById("RB_5").checked) {
                onclickSJ(14, true);
            }
            if (document.getElementById("RB_13").checked) {
                onclickSJ(15, true);
            }
            if (document.getElementById("RB_15").checked) {
                onclickSJ(16, true);
            }
            if (document.getElementById("RB_16").checked) {
                onclickSJ(17, true);
            }
            if (document.getElementById("RB_17").checked) {
                onclickSJ(18, true);
            }
    ...
    BP.Sys.Frm.MapAttrs attrs = new BP.Sys.Frm.MapAttrs("ND" + str + "Rpt");
    HashMap<String,String> DDL_5 = new HashMap<String,String>();
    for (BP.Sys.Frm.MapAttr item : BP.Sys.Frm.MapAttrs.convertMapAttrs(attrs)) {
                        ...
                        <table style="width: 100%;">
                            ...
                            <tr id="RB3">
                                <th>
                                    ...
                                    <div style="float: right">
                                        <a href="javascript:WinOpen('<%=basePath %>WF/Comm/RefFunc/Dot2DotSingle.jsp?EnsName=BP.WF.Template.Selectors&EnName=BP.WF.Template.Selector&AttrKey=BP.WF.Template.NodeEmps&NodeID=<%=nd.getNodeID() %>&r=<%=k %>&ShowWay=FK_Dept')">
...
<!--                                         <li style="font-size: 12px;">该配置也适合于</li> -->
                            ...
                            <tr id="RB4">
                                <th>
                                    ...
                                    <div style="float: right">
                                        <a href="javascript:WinOpen('<%=basePath %>WF/Comm/RefFunc/UIEn.jsp?EnName=BP.WF.Template.Selector&PK=<%=nd.getNodeID() %>')">
                                            设置处理人可以选择的范围</a></div>
                                </th>
                            </tr>
                            <tr id="YC_13">
                    ...
                    <div title="辅助属性" style="padding: 10px">
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <th>
                                    <div style="float: left">
                                        <input type="checkbox" <%if(CB_IsSSS){ %>checked="checked"<%} %> ID="CB_IsSSS"  Text="是否可以分配工作？" runat="server" />
                                    </div>
                                </th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>
                                    <div style="float: left">
                                        <input type="checkbox" <%if(CB_IsRememme){ %>checked="checked"<%} %> ID="CB_IsRememme" Text="是否启用自动记忆功能？" runat="server" />
                                    </div>
                                </th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th>
                                    <div style="float: left">
                                        <input type="checkbox" <%if(CB_IsExpSender){ %>checked="checked"<%} %> ID="CB_IsExpSender" Text="本节点接收人不允许包含上一步发送人？" runat="server" />
                                    </div>
                                </th>
                            </tr>
                            <tr>
