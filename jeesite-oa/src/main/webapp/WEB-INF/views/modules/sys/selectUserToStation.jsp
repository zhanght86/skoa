	...
	<script type="text/javascript">
		...
		function treeOnClick(event, treeId, treeNode, clickFlag){
			...
			if("officeTree"==treeId){
				$.get("${ctx}/sys/station/users?officeId=" + treeNode.id, function(userNodes){
		...
		function clearAssign(){
			...
			tips="确定清除岗位【${station.name}】下的已选人员？";
			top.$.jBox.confirm(tips, "清除确认", submit);
		};
	</script>
</head>
<body>
	<div id="assignStation" class="row-fluid span12">
